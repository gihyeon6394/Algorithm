...
- 논리 표현식, 조건문이나 반복문에서 중요한 역할

#### 기타 기본 데이터 타입

- int, double로 대부분의 정수, 실수 연산 가능
...
#### 단일 명령문 블록 : 조건문의 실행 블록ㅇ나 루프 바디가 한줄이면 중괄호 생략

#### for 구문

- while -> for로 축약 가능
- for : 초기화, 증가 작업이 필요할 떄
...
- 클라이언트들에게 그 메서드가 어떤 기능을 하는지 설명 필요
